...
void main(){
    ...
    col.rgb+=(fract(sin(dot(gl_FragCoord.xy+uTime,vec2(12.9898,78.233)))*43758.5453)-0.5)*uNoise;
    gl_FragColor=vec4(clamp(col.rgb,0.0,1.0),1.0);
}
`;

function initDarkVeil() {
  const ctn = document.getElementById('dark-veil-bg');
  if (!ctn) return;
